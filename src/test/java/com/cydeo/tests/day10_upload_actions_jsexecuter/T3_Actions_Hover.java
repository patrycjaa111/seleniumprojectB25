...
public class T3_Actions_Hover {
    ...
    public void hovering_test() {
        ...
        WebElement img1 = Driver.getDriver().findElement(By.xpath("(//img)[1]"));   // the perenthesis allow to index thru different siblings that are not under the same parent
        ...
        Actions actions = new Actions(Driver.getDriver());  // returns driver instance

        //2. Hover over to first image
        BrowserUtils.sleep(2);
        actions.moveToElement(img1).perform();        // ALWAYS remember about .perform();
